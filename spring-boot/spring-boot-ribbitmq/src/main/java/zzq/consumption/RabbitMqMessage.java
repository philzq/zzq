...
public class RabbitMqMessage {
    ...
    @RabbitListener(queues = "testFirst", containerFactory = "firstFactory",concurrency = "1-5")
    ...
    @RabbitListener(queues = "testSecond", containerFactory = "secondFactory",concurrency = "1-5")
