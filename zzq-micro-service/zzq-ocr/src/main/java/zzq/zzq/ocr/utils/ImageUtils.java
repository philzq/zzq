...
public class ImageUtils {
     ...
     * @throws IOException
     */
    public static File cleanImage(File sfile, String destDir)throws IOException{
        ...
        File output = new File(destDir, "output_"+sfile.getName());
        ImageIO.write(binaryBufferedImage, "png", output);
        return output;
    }
