 ...
 */
@GUIMenuSortOrder(1)
@TestElementMetadata(labelResource = "ResponseAssertionTest")
public class AssertionGuiTest extends AbstractAssertionGui {
    ...
    public AssertionGuiTest() {
        init();
    }

    @Override
    public String getLabelResource() {
        return "ResponseAssertionTest"; // $NON-NLS-1$
    }
    ...
    public TestElement createTestElement() {
        ...
        ResponseAssertionTest el = new ResponseAssertionTest();
    ...
    public void modifyTestElement(TestElement el) {
        ...
        if (el instanceof ResponseAssertionTest) {
            ResponseAssertionTest ra = (ResponseAssertionTest) el;
    ...
    public void configure(TestElement el) {
        super.configure(el);
        ResponseAssertionTest model = (ResponseAssertionTest) el;
